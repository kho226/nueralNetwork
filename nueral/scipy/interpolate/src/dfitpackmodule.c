...
static PyObject *f2py_rout_dfitpack_splev(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(double*,int*,double*,int*,double*,double*,int*,int*,int*)) {
  PyObject * volatile capi_buildvalue = NULL;
  volatile int f2py_success = 1;
/*decl*/
...
/*frompyobj*/
  ...
  if (f2py_success) {
  CHECKSCALAR(0<=e && e<=2,"0<=e && e<=2","1st keyword e","splev:e=%d",e) {
  /* Processing variable m */
  m = len(x);
  /* Processing variable n */
  n = len(t);
...
static PyObject *f2py_rout_dfitpack_splder(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(double*,int*,double*,int*,int*,double*,double*,int*,int*,double*,int*)) {
  PyObject * volatile capi_buildvalue = NULL;
  volatile int f2py_success = 1;
/*decl*/
...
/*frompyobj*/
  ...
  if (f2py_success) {
  CHECKSCALAR(0<=e && e<=2,"0<=e && e<=2","2nd keyword e","splder:e=%d",e) {
  /* Processing variable m */
  m = len(x);
  /* Processing variable n */
  n = len(t);
...
/*callfortranroutine*/
      Py_BEGIN_ALLOW_THREADS
        (*f2py_func)(t,&n,c,&k,&nu,x,y,&m,&e,wrk,&ier);
      Py_END_ALLOW_THREADS
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*frompyobj*/
  ...
  zero_Dims[0]=mest;
  capi_zero_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  capi_zero_tmp = array_from_pyobj(NPY_DOUBLE,zero_Dims,zero_Rank,capi_zero_intent,Py_None);
  if (capi_zero_tmp == NULL) {
    ...
    zero = (double *)(PyArray_DATA(capi_zero_tmp));
...
/*frompyobj*/
  ...
  capi_iwrk_tmp = array_from_pyobj(NPY_INT,iwrk_Dims,iwrk_Rank,capi_iwrk_intent,iwrk_capi);
...
/*frompyobj*/
  ...
  if (w_capi == Py_None) {
    ...
    if (initforcomb(PyArray_DIMS(capi_w_tmp),PyArray_NDIM(capi_w_tmp),1)) {
  ...
  nrdata_Dims[0]=nest;
  capi_nrdata_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT|F2PY_INTENT_CACHE;
  capi_nrdata_tmp = array_from_pyobj(NPY_INT,nrdata_Dims,nrdata_Rank,capi_nrdata_intent,Py_None);
  if (capi_nrdata_tmp == NULL) {
    ...
    nrdata = (int *)(PyArray_DATA(capi_nrdata_tmp));
  ...
  fpint_Dims[0]=nest;
  capi_fpint_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT|F2PY_INTENT_CACHE;
  capi_fpint_tmp = array_from_pyobj(NPY_DOUBLE,fpint_Dims,fpint_Rank,capi_fpint_intent,Py_None);
  if (capi_fpint_tmp == NULL) {
    ...
    fpint = (double *)(PyArray_DATA(capi_fpint_tmp));
...
/*frompyobj*/
  ...
  capi_nrdata_tmp = array_from_pyobj(NPY_INT,nrdata_Dims,nrdata_Rank,capi_nrdata_intent,nrdata_capi);
  if (capi_nrdata_tmp == NULL) {
    if (!PyErr_Occurred())
  ...
  capi_fpint_tmp = array_from_pyobj(NPY_DOUBLE,fpint_Dims,fpint_Rank,capi_fpint_intent,fpint_capi);
  if (capi_fpint_tmp == NULL) {
    if (!PyErr_Occurred())
...
/*frompyobj*/
  ...
  capi_z_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_C|F2PY_INTENT_OUT;
...
/*frompyobj*/
  ...
  if (capi_ty_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 2nd argument `ty' of dfitpack.parder to C/Fortran array" );
  } else {
    ty = (double *)(PyArray_DATA(capi_ty_tmp));
  ...
  if (capi_x_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 8th argument `x' of dfitpack.parder to C/Fortran array" );
  } else {
    x = (double *)(PyArray_DATA(capi_x_tmp));
  ...
  if (capi_tx_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 1st argument `tx' of dfitpack.parder to C/Fortran array" );
  } else {
    tx = (double *)(PyArray_DATA(capi_tx_tmp));
  ...
  if (capi_y_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 9th argument `y' of dfitpack.parder to C/Fortran array" );
  } else {
    y = (double *)(PyArray_DATA(capi_y_tmp));
  ...
  if (capi_wrk_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `wrk' of dfitpack.parder to C/Fortran array" );
  } else {
    wrk = (double *)(PyArray_DATA(capi_wrk_tmp));
  ...
  if (capi_z_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `z' of dfitpack.parder to C/Fortran array" );
  } else {
    z = (double *)(PyArray_DATA(capi_z_tmp));
  ...
  if (capi_c_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 3rd argument `c' of dfitpack.parder to C/Fortran array" );
  } else {
    c = (double *)(PyArray_DATA(capi_c_tmp));
  ...
  if (capi_iwrk_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `iwrk' of dfitpack.parder to C/Fortran array" );
  } else {
    iwrk = (int *)(PyArray_DATA(capi_iwrk_tmp));
...
/*frompyobj*/
  ...
  if (capi_ty_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 2nd argument `ty' of dfitpack.pardeu to C/Fortran array" );
  } else {
    ty = (double *)(PyArray_DATA(capi_ty_tmp));
  ...
  if (capi_x_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 8th argument `x' of dfitpack.pardeu to C/Fortran array" );
  } else {
    x = (double *)(PyArray_DATA(capi_x_tmp));
  ...
  if (capi_tx_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 1st argument `tx' of dfitpack.pardeu to C/Fortran array" );
  } else {
    tx = (double *)(PyArray_DATA(capi_tx_tmp));
  ...
  if (capi_y_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 9th argument `y' of dfitpack.pardeu to C/Fortran array" );
  } else {
    y = (double *)(PyArray_DATA(capi_y_tmp));
  ...
  if (capi_iwrk_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `iwrk' of dfitpack.pardeu to C/Fortran array" );
  } else {
    iwrk = (int *)(PyArray_DATA(capi_iwrk_tmp));
  ...
  if (capi_wrk_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `wrk' of dfitpack.pardeu to C/Fortran array" );
  } else {
    wrk = (double *)(PyArray_DATA(capi_wrk_tmp));
  ...
  if (capi_z_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `z' of dfitpack.pardeu to C/Fortran array" );
  } else {
    z = (double *)(PyArray_DATA(capi_z_tmp));
  ...
  if (capi_c_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 3rd argument `c' of dfitpack.pardeu to C/Fortran array" );
  } else {
    c = (double *)(PyArray_DATA(capi_c_tmp));
...
/*frompyobj*/
  ...
  /* Processing variable ty */
  ty_Dims[0]=nmax;
  capi_ty_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  wrk1_Dims[0]=lwrk1;
  capi_wrk1_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT|F2PY_INTENT_CACHE;
  capi_wrk1_tmp = array_from_pyobj(NPY_DOUBLE,wrk1_Dims,wrk1_Rank,capi_wrk1_intent,Py_None);
  if (capi_wrk1_tmp == NULL) {
    ...
    wrk1 = (double *)(PyArray_DATA(capi_wrk1_tmp));
  ...
  /* Processing variable tx */
  tx_Dims[0]=nmax;
  capi_tx_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  capi_wrk2_tmp = array_from_pyobj(NPY_DOUBLE,wrk2_Dims,wrk2_Rank,capi_wrk2_intent,Py_None);
  if (capi_wrk2_tmp == NULL) {
    ...
    wrk2 = (double *)(PyArray_DATA(capi_wrk2_tmp));
...
/*frompyobj*/
  ...
  capi_teta_tmp = array_from_pyobj(NPY_DOUBLE,teta_Dims,teta_Rank,capi_teta_intent,teta_capi);
  if (capi_teta_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 1st argument `teta' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
  ...
  if (capi_r_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 3rd argument `r' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
  ...
  tp_Dims[0]=npest;
  capi_tp_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  capi_tp_tmp = array_from_pyobj(NPY_DOUBLE,tp_Dims,tp_Rank,capi_tp_intent,Py_None);
  if (capi_tp_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `tp' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
  ...
  if (capi_phi_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 2nd argument `phi' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
  ...
  if (capi_w_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 1st keyword `w' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
    w = (double *)(PyArray_DATA(capi_w_tmp));
  ...
  CHECKARRAY(len(w)==m,"len(w)==m","1st keyword w") {
  /* Processing variable c */
  c_Dims[0]=(ntest-4)*(npest-4);
  capi_c_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  capi_c_tmp = array_from_pyobj(NPY_DOUBLE,c_Dims,c_Rank,capi_c_intent,Py_None);
  if (capi_c_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `c' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
    c = (double *)(PyArray_DATA(capi_c_tmp));
  ...
  tt_Dims[0]=ntest;
  capi_tt_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  capi_tt_tmp = array_from_pyobj(NPY_DOUBLE,tt_Dims,tt_Rank,capi_tt_intent,Py_None);
  if (capi_tt_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `tt' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
  ...
  if (capi_wrk1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `wrk1' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
    wrk1 = (double *)(PyArray_DATA(capi_wrk1_tmp));
  ...
  if (capi_wrk2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `wrk2' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
    wrk2 = (double *)(PyArray_DATA(capi_wrk2_tmp));
  ...
  if (capi_iwrk_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `iwrk' of dfitpack.spherfit_smth to C/Fortran array" );
  } else {
    iwrk = (int *)(PyArray_DATA(capi_iwrk_tmp));
...
/*end of pyobjfrom*/
    CFUNCSMESS("Building return value.\n");
    capi_buildvalue = Py_BuildValue("iNiNNdi",nt,capi_tt_tmp,np,capi_tp_tmp,capi_c_tmp,fp,ier);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
    } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
  ...
  if((PyObject *)capi_teta_tmp!=teta_capi) {
    Py_XDECREF(capi_teta_tmp); }
...
/*frompyobj*/
  ...
  if (capi_tt_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 4th argument `tt' of dfitpack.spherfit_lsq to C/Fortran array" );
  } else {
    tt = (double *)(PyArray_DATA(capi_tt_tmp));
  ...
  if (capi_teta_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 1st argument `teta' of dfitpack.spherfit_lsq to C/Fortran array" );
  } else {
    teta = (double *)(PyArray_DATA(capi_teta_tmp));
  ...
  if (capi_tp_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 5th argument `tp' of dfitpack.spherfit_lsq to C/Fortran array" );
  } else {
    tp = (double *)(PyArray_DATA(capi_tp_tmp));
  ...
  if (capi_r_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 3rd argument `r' of dfitpack.spherfit_lsq to C/Fortran array" );
  } else {
    r = (double *)(PyArray_DATA(capi_r_tmp));
  ...
  if (capi_phi_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 2nd argument `phi' of dfitpack.spherfit_lsq to C/Fortran array" );
  } else {
    phi = (double *)(PyArray_DATA(capi_phi_tmp));
  ...
  if (capi_w_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 1st keyword `w' of dfitpack.spherfit_lsq to C/Fortran array" );
  } else {
    w = (double *)(PyArray_DATA(capi_w_tmp));
  ...
  if (capi_wrk1_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `wrk1' of dfitpack.spherfit_lsq to C/Fortran array" );
  } else {
    wrk1 = (double *)(PyArray_DATA(capi_wrk1_tmp));
  ...
  if (capi_wrk2_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `wrk2' of dfitpack.spherfit_lsq to C/Fortran array" );
  } else {
    wrk2 = (double *)(PyArray_DATA(capi_wrk2_tmp));
  ...
  if (capi_c_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `c' of dfitpack.spherfit_lsq to C/Fortran array" );
  } else {
    c = (double *)(PyArray_DATA(capi_c_tmp));
  ...
  if (capi_iwrk_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `iwrk' of dfitpack.spherfit_lsq to C/Fortran array" );
  } else {
    iwrk = (int *)(PyArray_DATA(capi_iwrk_tmp));
...
/*end of pyobjfrom*/
    CFUNCSMESS("Building return value.\n");
    capi_buildvalue = Py_BuildValue("NNNdi",capi_tt_tmp,capi_tp_tmp,capi_c_tmp,fp,ier);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
    } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
...
/*decl*/
  ...
  PyArrayObject *capi_ider_tmp = NULL;
  ...
  const int tu_Rank = 1;
  PyArrayObject *capi_tu_tmp = NULL;
...
/*frompyobj*/
  ...
  if (capi_u_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 3rd argument `u' of dfitpack.regrid_smth_spher to C/Fortran array" );
  } else {
    u = (double *)(PyArray_DATA(capi_u_tmp));
  ...
  if (capi_iopt_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 1st argument `iopt' of dfitpack.regrid_smth_spher to C/Fortran array" );
  } else {
    iopt = (int *)(PyArray_DATA(capi_iopt_tmp));

  /* Processing variable nv */
  /* Processing variable ider */
  ider_Dims[0]=4;
  capi_ider_intent |= F2PY_INTENT_IN;
  capi_ider_tmp = array_from_pyobj(NPY_INT,ider_Dims,ider_Rank,capi_ider_intent,ider_capi);
  if (capi_ider_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 2nd argument `ider' of dfitpack.regrid_smth_spher to C/Fortran array" );
  } else {
    ider = (int *)(PyArray_DATA(capi_ider_tmp));
  ...
  if (capi_v_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 4th argument `v' of dfitpack.regrid_smth_spher to C/Fortran array" );
  } else {
  ...
  tv_Dims[0]=nvest;
  capi_tv_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  capi_tv_tmp = array_from_pyobj(NPY_DOUBLE,tv_Dims,tv_Rank,capi_tv_intent,Py_None);
  if (capi_tv_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `tv' of dfitpack.regrid_smth_spher to C/Fortran array" );
  } else {
  ...
  if (capi_r_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting 5th argument `r' of dfitpack.regrid_smth_spher to C/Fortran array" );
  } else {
    r = (double *)(PyArray_DATA(capi_r_tmp));
  ...
  /* Processing variable c */
  c_Dims[0]=(nuest-4)*(nvest-4);
  capi_c_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  capi_c_tmp = array_from_pyobj(NPY_DOUBLE,c_Dims,c_Rank,capi_c_intent,Py_None);
  if (capi_c_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `c' of dfitpack.regrid_smth_spher to C/Fortran array" );
  } else {
    c = (double *)(PyArray_DATA(capi_c_tmp));
  ...
  tu_Dims[0]=nuest;
  capi_tu_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  capi_tu_tmp = array_from_pyobj(NPY_DOUBLE,tu_Dims,tu_Rank,capi_tu_intent,Py_None);
  if (capi_tu_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `tu' of dfitpack.regrid_smth_spher to C/Fortran array" );
  } else {
    tu = (double *)(PyArray_DATA(capi_tu_tmp));
  ...
  if (capi_wrk_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `wrk' of dfitpack.regrid_smth_spher to C/Fortran array" );
  } else {
    wrk = (double *)(PyArray_DATA(capi_wrk_tmp));
  ...
  if (capi_iwrk_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(dfitpack_error,"failed in converting hidden `iwrk' of dfitpack.regrid_smth_spher to C/Fortran array" );
  } else {
    iwrk = (int *)(PyArray_DATA(capi_iwrk_tmp));
...
/*end of pyobjfrom*/
    CFUNCSMESS("Building return value.\n");
    capi_buildvalue = Py_BuildValue("iNiNNdi",nu,capi_tu_tmp,nv,capi_tv_tmp,capi_c_tmp,fp,ier);
/*closepyobjfrom*/
/*end of closepyobjfrom*/
    } /*if (f2py_success) after callfortranroutine*/
/*cleanupfrompyobj*/
  ...
  /* End of cleaning variable wrk */
  }  /*if (capi_tu_tmp == NULL) ... else of tu*/
  ...
  if((PyObject *)capi_ider_tmp!=ider_capi) {
    Py_XDECREF(capi_ider_tmp); }
  }  /*if (capi_ider_tmp == NULL) ... else of ider*/
  /* End of cleaning variable ider */
  /* End of cleaning variable nv */
  if((PyObject *)capi_iopt_tmp!=iopt_capi) {
    Py_XDECREF(capi_iopt_tmp); }
...
static FortranDataDef f2py_routine_defs[] = {
  ...
  {"parder",-1,{{-1}},0,(char *)F_FUNC(parder,PARDER),(f2py_init_func)f2py_rout_dfitpack_parder,doc_f2py_rout_dfitpack_parder},
  {"bispeu",-1,{{-1}},0,(char *)F_FUNC(bispeu,BISPEU),(f2py_init_func)f2py_rout_dfitpack_bispeu,doc_f2py_rout_dfitpack_bispeu},
  {"pardeu",-1,{{-1}},0,(char *)F_FUNC(pardeu,PARDEU),(f2py_init_func)f2py_rout_dfitpack_pardeu,doc_f2py_rout_dfitpack_pardeu},
  ...
  {"spherfit_smth",-1,{{-1}},0,(char *)F_FUNC(sphere,SPHERE),(f2py_init_func)f2py_rout_dfitpack_spherfit_smth,doc_f2py_rout_dfitpack_spherfit_smth},
  {"spherfit_lsq",-1,{{-1}},0,(char *)F_FUNC(sphere,SPHERE),(f2py_init_func)f2py_rout_dfitpack_spherfit_lsq,doc_f2py_rout_dfitpack_spherfit_lsq},
  ...
  {"regrid_smth_spher",-1,{{-1}},0,(char *)F_FUNC(spgrid,SPGRID),(f2py_init_func)f2py_rout_dfitpack_regrid_smth_spher,doc_f2py_rout_dfitpack_regrid_smth_spher},
...
".");
  ...
  for(i=0;f2py_routine_defs[i].name!=NULL;i++)
...

    {
      ...
      PyObject_SetAttrString(o,"_cpointer", F2PyCapsule_FromVoidPtr((void*)F_FUNC(splint,SPLINT),NULL));
#if PY_VERSION_HEX >= 0x03000000
      PyObject_SetAttrString(o,"__name__", PyUnicode_FromString("splint"));
#else
      PyObject_SetAttrString(o,"__name__", PyString_FromString("splint"));
#endif
    }
...

    {
      ...
      PyObject_SetAttrString(o,"_cpointer", F2PyCapsule_FromVoidPtr((void*)F_FUNC(dblint,DBLINT),NULL));
#if PY_VERSION_HEX >= 0x03000000
      PyObject_SetAttrString(o,"__name__", PyUnicode_FromString("dblint"));
#else
      PyObject_SetAttrString(o,"__name__", PyString_FromString("dblint"));
#endif
    }
