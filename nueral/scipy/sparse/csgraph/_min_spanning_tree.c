...
#define __PYX_HAVE__scipy__sparse__csgraph___min_spanning_tree
#define __PYX_HAVE_API__scipy__sparse__csgraph___min_spanning_tree
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
static const char *__pyx_f[] = {
  ...
  "__init__.pxd",
  "scipy/sparse/csgraph/stringsource",
  "type.pxd",
 ...
 * ITYPE = np.int32
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t;
 ...
 */
typedef __pyx_t_5numpy_int32_t __pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t(PyObject *);

static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t(PyObject *);
...
/* Module declarations from 'scipy.sparse.csgraph._min_spanning_tree' */
...
static void __pyx_f_5scipy_6sparse_7csgraph_18_min_spanning_tree__min_spanning_tree(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t = { "ITYPE_t", NULL, sizeof(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t), 0 };
#define __Pyx_MODULE_NAME "scipy.sparse.csgraph._min_spanning_tree"
int __pyx_module_is_main_scipy__sparse__csgraph___min_spanning_tree = 0;

/* Implementation of 'scipy.sparse.csgraph._min_spanning_tree' */
...
static char __pyx_k_minimum_spanning_tree_line_13[] = "minimum_spanning_tree (line 13)";
static char __pyx_k_unable_to_allocate_array_data[] = "unable to allocate array data.";
static char __pyx_k_strided_and_direct_or_indirect[] = "<strided and direct or indirect>";
static char __pyx_k_Users_kyleong_Dropbox_nueral_sc[] = "/Users/kyleong/Dropbox/nueral/scipy-0.18.1/scipy/sparse/csgraph/_min_spanning_tree.pyx";
...
static char __pyx_k_scipy_sparse_csgraph__min_spanni[] = "scipy.sparse.csgraph._min_spanning_tree";
...
static PyObject *__pyx_kp_u_minimum_spanning_tree_line_13;
...
static PyObject *__pyx_n_s_scipy_sparse_csgraph__min_spanni;
...
static PyObject *__pyx_pf_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_csgraph, PyObject *__pyx_v_overwrite); /* proto */
...
/* "scipy/sparse/csgraph/_min_spanning_tree.pyx":13
...
/* Python wrapper */
static PyObject *__pyx_pw_5scipy_6sparse_7csgraph_18_min_spanning_tree_1minimum_spanning_tree(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree[] = "\n    minimum_spanning_tree(csgraph, overwrite=False)\n\n    Return a minimum spanning tree of an undirected graph\n\n    A minimum spanning tree is a graph consisting of the subset of edges\n    which together connect all connected nodes, while minimizing the total\n    sum of weights on the edges.  This is computed using the Kruskal algorithm.\n\n    .. versionadded:: 0.11.0\n\n    Parameters\n    ----------\n    csgraph : array_like or sparse matrix, 2 dimensions\n        The N x N matrix representing an undirected graph over N nodes\n        (see notes below).\n    overwrite : bool, optional\n        if true, then parts of the input graph will be overwritten for\n        efficiency.\n\n    Returns\n    -------\n    span_tree : csr matrix\n        The N x N compressed-sparse representation of the undirected minimum\n        spanning tree over the input (see notes below).\n\n    Notes\n    -----\n    This routine uses undirected graphs as input and output.  That is, if\n    graph[i, j] and graph[j, i] are both zero, then nodes i and j do not\n    have an edge connecting them.  If either is nonzero, then the two are\n    connected by the minimum nonzero value of the two.\n\n    Examples\n    --------\n    The following example shows the computation of a minimum spanning tree\n    over a simple four-component graph::\n\n         input graph             minimum spanning tree\n\n             (0)                         (0)\n            /   \\                       /\n           3     8                     3\n          /       \\                   /\n        (3)---5---(1)               (3)---5---(1)\n          \\       /                           /\n           6     2                           2\n            \\   /                           /\n             (2)                         (2)\n\n    It is easy to see from inspection that the minimum spanning tree involves\n    removing the edges with weights 8 and 6.  In compressed sparse\n    representation, the solution l""ooks like this:\n\n    >>> from scipy.sparse import csr_matrix\n    >>> from scipy.sparse.csgraph import minimum_spanning_tree\n    >>> X = csr_matrix([[0, 8, 0, 3],\n    ...                 [0, 0, 2, 5],\n    ...                 [0, 0, 0, 6],\n    ...                 [0, 0, 0, 0]])\n    >>> Tcsr = minimum_spanning_tree(X)\n    >>> Tcsr.toarray().astype(int)\n    array([[0, 0, 0, 3],\n           [0, 0, 2, 5],\n           [0, 0, 0, 0],\n           [0, 0, 0, 0]])\n    ";
static PyMethodDef __pyx_mdef_5scipy_6sparse_7csgraph_18_min_spanning_tree_1minimum_spanning_tree = {"minimum_spanning_tree", (PyCFunction)__pyx_pw_5scipy_6sparse_7csgraph_18_min_spanning_tree_1minimum_spanning_tree, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree};
static PyObject *__pyx_pw_5scipy_6sparse_7csgraph_18_min_spanning_tree_1minimum_spanning_tree(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("minimum_spanning_tree (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "minimum_spanning_tree") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("minimum_spanning_tree", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("scipy.sparse.csgraph._min_spanning_tree.minimum_spanning_tree", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree(__pyx_self, __pyx_v_csgraph, __pyx_v_overwrite);
...
static PyObject *__pyx_pf_5scipy_6sparse_7csgraph_18_min_spanning_tree_minimum_spanning_tree(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_csgraph, PyObject *__pyx_v_overwrite) {
  int __pyx_v_N;
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":83
 *     global NULL_IDX
 * 
 ...
 */
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_validate_graph); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPE); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dense_output, Py_False) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":84
 * 
 *     csgraph = validate_graph(csgraph, True, DTYPE, dense_output=False,
 *                              copy_if_sparse=not overwrite)             # <<<<<<<<<<<<<<
 *     cdef int N = csgraph.shape[0]
 * 
 */
  __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_v_overwrite); if (unlikely(__pyx_t_4 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_5 = __Pyx_PyBool_FromLong((!__pyx_t_4)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_copy_if_sparse, __pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef int N = csgraph.shape[0]
 */
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":85
 *     csgraph = validate_graph(csgraph, True, DTYPE, dense_output=False,
 *                              copy_if_sparse=not overwrite)
 *     cdef int N = csgraph.shape[0]             # <<<<<<<<<<<<<<
 * 
 *     data = csgraph.data
 */
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_csgraph, __pyx_n_s_shape); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_GetItemInt(__pyx_t_5, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(__pyx_t_2 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_t_2); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_N = __pyx_t_6;

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":87
 *     cdef int N = csgraph.shape[0]
 * 
 *     data = csgraph.data             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_csgraph, __pyx_n_s_data); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_data = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":88
 * 
 *     data = csgraph.data
 *     indices = csgraph.indices             # <<<<<<<<<<<<<<
 *     indptr = csgraph.indptr
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_csgraph, __pyx_n_s_indices); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_indices = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":89
 *     data = csgraph.data
 *     indices = csgraph.indices
 *     indptr = csgraph.indptr             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_csgraph, __pyx_n_s_indptr); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_indptr = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":91
 *     indptr = csgraph.indptr
 * 
 *     rank = np.zeros(N, dtype=ITYPE)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_N); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_ITYPE); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":92
 * 
 *     rank = np.zeros(N, dtype=ITYPE)
 *     predecessors = np.arange(N, dtype=ITYPE)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_arange); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_N); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_GetModuleGlobalName(__pyx_n_s_ITYPE); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":94
 *     predecessors = np.arange(N, dtype=ITYPE)
 * 
 *     i_sort = np.argsort(data).astype(ITYPE)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_argsort); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_astype); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_ITYPE); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_7 = NULL;
  ...
  if (!__pyx_t_7) {
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_GOTREF(__pyx_t_5);
  } else {
    ...
    __pyx_t_1 = 0;
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  }
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_i_sort = __pyx_t_5;
  __pyx_t_5 = 0;

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":95
 * 
 *     i_sort = np.argsort(data).astype(ITYPE)
 *     row_indices = np.zeros(len(data), dtype=ITYPE)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_8 = PyObject_Length(__pyx_v_data); if (unlikely(__pyx_t_8 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_5 = PyInt_FromSsize_t(__pyx_t_8); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_ITYPE); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":97
 *     row_indices = np.zeros(len(data), dtype=ITYPE)
 * 
 *     _min_spanning_tree(data, indices, indptr, i_sort,             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t(__pyx_v_data);
  if (unlikely(!__pyx_t_9.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t(__pyx_v_indices);
  if (unlikely(!__pyx_t_10.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t(__pyx_v_indptr);
  if (unlikely(!__pyx_t_11.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_12 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t(__pyx_v_i_sort);
  if (unlikely(!__pyx_t_12.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":98
 * 
 *     _min_spanning_tree(data, indices, indptr, i_sort,
 *                        row_indices, predecessors, rank)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_13 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t(__pyx_v_row_indices);
  if (unlikely(!__pyx_t_13.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_14 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t(__pyx_v_predecessors);
  if (unlikely(!__pyx_t_14.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_15 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t(__pyx_v_rank);
  if (unlikely(!__pyx_t_15.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_f_5scipy_6sparse_7csgraph_18_min_spanning_tree__min_spanning_tree(__pyx_t_9, __pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_15);
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":100
 *                        row_indices, predecessors, rank)
 * 
 *     sp_tree = csr_matrix((data, indices, indptr), (N, N))             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_5 = __Pyx_GetModuleGlobalName(__pyx_n_s_csr_matrix); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_N); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_N); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  ...
  __pyx_t_2 = PyTuple_New(2+__pyx_t_8); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (__pyx_t_7) {
  ...
  PyTuple_SET_ITEM(__pyx_t_2, 1+__pyx_t_8, __pyx_t_16);
  __pyx_t_3 = 0;
  __pyx_t_16 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_2, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_sp_tree = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":101
 * 
 *     sp_tree = csr_matrix((data, indices, indptr), (N, N))
 *     sp_tree.eliminate_zeros()             # <<<<<<<<<<<<<<
 * 
 *     return sp_tree
 */
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_sp_tree, __pyx_n_s_eliminate_zeros); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = NULL;
  ...
  if (__pyx_t_2) {
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  } else {
    __pyx_t_1 = __Pyx_PyObject_CallNoArg(__pyx_t_5); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 101; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":103
 *     sp_tree.eliminate_zeros()
 * 
 *     return sp_tree             # <<<<<<<<<<<<<<
 * 
...
/* "scipy/sparse/csgraph/_min_spanning_tree.pyx":108
...
static void __pyx_f_5scipy_6sparse_7csgraph_18_min_spanning_tree__min_spanning_tree(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_col_indices, __Pyx_memviewslice __pyx_v_indptr, __Pyx_memviewslice __pyx_v_i_sort, __Pyx_memviewslice __pyx_v_row_indices, __Pyx_memviewslice __pyx_v_predecessors, __Pyx_memviewslice __pyx_v_rank) {
  ...
  unsigned int __pyx_v_n_data;
  unsigned int __pyx_t_1;
  unsigned int __pyx_t_2;
  Py_ssize_t __pyx_t_3;
  __pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t __pyx_t_4;
  size_t __pyx_t_5;
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":119
 *     #  efficient indexing.
 ...
 * 
 */
  __pyx_v_n_verts = (__pyx_v_predecessors.shape[0]);

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":120
 *     cdef unsigned int i, j, V1, V2, R1, R2, n_edges_in_mst, n_verts, n_data
 *     n_verts = predecessors.shape[0]
 *     n_data = i_sort.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_n_data = (__pyx_v_i_sort.shape[0]);

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":124
 *     # Arrange `row_indices` to contain the row index of each value in `data`.
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":125
 *     # Note that the array `col_indices` already contains the column index.
 *     for i in range(n_verts):
 *         for j in range(indptr[i], indptr[i + 1]):             # <<<<<<<<<<<<<<
 *             row_indices[j] = i
 ...
 */
    ...
    __pyx_t_4 = (*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_indptr.data) + __pyx_t_3)) )));
    __pyx_t_5 = __pyx_v_i;
    for (__pyx_t_6 = (*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_indptr.data) + __pyx_t_5)) ))); __pyx_t_6 < __pyx_t_4; __pyx_t_6+=1) {
      ...
      /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":126
 *     for i in range(n_verts):
 *         for j in range(indptr[i], indptr[i + 1]):
 *             row_indices[j] = i             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = __pyx_v_j;
      *((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_row_indices.data) + __pyx_t_7)) )) = __pyx_v_i;
    }
  }

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":130
 *     # step through the edges from smallest to largest.
 ...
 */
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":131
 *     #  V1 and V2 are connected vertices.
 *     n_edges_in_mst = 0
 *     i = 0             # <<<<<<<<<<<<<<
 *     while i < n_data and n_edges_in_mst < n_verts - 1:
 ...
 */
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":132
 *     n_edges_in_mst = 0
 *     i = 0
 *     while i < n_data and n_edges_in_mst < n_verts - 1:             # <<<<<<<<<<<<<<
 *         j = i_sort[i]
 ...
 */
  while (1) {
    __pyx_t_9 = ((__pyx_v_i < __pyx_v_n_data) != 0);
    if (__pyx_t_9) {
    } else {
      __pyx_t_8 = __pyx_t_9;
      goto __pyx_L9_bool_binop_done;
    }
    __pyx_t_9 = ((__pyx_v_n_edges_in_mst < (__pyx_v_n_verts - 1)) != 0);
    __pyx_t_8 = __pyx_t_9;
    __pyx_L9_bool_binop_done:;
    if (!__pyx_t_8) break;

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":133
 *     i = 0
 *     while i < n_data and n_edges_in_mst < n_verts - 1:
 *         j = i_sort[i]             # <<<<<<<<<<<<<<
 *         V1 = row_indices[j]
 ...
 */
    ...
    __pyx_v_j = (*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_i_sort.data) + __pyx_t_10)) )));

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":134
 *     while i < n_data and n_edges_in_mst < n_verts - 1:
 *         j = i_sort[i]
 *         V1 = row_indices[j]             # <<<<<<<<<<<<<<
 *         V2 = col_indices[j]
 ...
 */
    ...
    __pyx_v_V1 = (*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_row_indices.data) + __pyx_t_11)) )));

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":135
 *         j = i_sort[i]
 *         V1 = row_indices[j]
 *         V2 = col_indices[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_v_V2 = (*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_col_indices.data) + __pyx_t_12)) )));

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":138
 * 
 *         # progress upward to the head node of each subtree
 *         R1 = V1             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":139
 *         # progress upward to the head node of each subtree
 *         R1 = V1
 *         while predecessors[R1] != R1:             # <<<<<<<<<<<<<<
 *             R1 = predecessors[R1]
 ...
 */
    while (1) {
      ...
      /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":140
 *         R1 = V1
 *         while predecessors[R1] != R1:
 *             R1 = predecessors[R1]             # <<<<<<<<<<<<<<
 *         R2 = V2
 ...
 */
      ...
      __pyx_v_R1 = (*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_predecessors.data) + __pyx_t_14)) )));
    }

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":141
 *         while predecessors[R1] != R1:
 *             R1 = predecessors[R1]
 *         R2 = V2             # <<<<<<<<<<<<<<
 *         while predecessors[R2] != R2:
 ...
 */
    ...
    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":142
 *             R1 = predecessors[R1]
 *         R2 = V2
 *         while predecessors[R2] != R2:             # <<<<<<<<<<<<<<
 *             R2 = predecessors[R2]
 ...
 */
    while (1) {
      ...
      /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":143
 *         R2 = V2
 *         while predecessors[R2] != R2:
 *             R2 = predecessors[R2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_R2 = (*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_predecessors.data) + __pyx_t_16)) )));
    }

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":146
 * 
 *         # Compress both paths.
 ...
 */
    while (1) {
      ...
      /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":147
 *         # Compress both paths.
 *         while predecessors[V1] != R1:
 *             predecessors[V1] = R1             # <<<<<<<<<<<<<<
 *         while predecessors[V2] != R2:
 ...
 */
      ...
      *((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_predecessors.data) + __pyx_t_18)) )) = __pyx_v_R1;
    }

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":148
 *         while predecessors[V1] != R1:
 *             predecessors[V1] = R1
 *         while predecessors[V2] != R2:             # <<<<<<<<<<<<<<
 *             predecessors[V2] = R2
 ...
 */
    while (1) {
      ...
      /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":149
 *             predecessors[V1] = R1
 *         while predecessors[V2] != R2:
 *             predecessors[V2] = R2             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      *((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_predecessors.data) + __pyx_t_20)) )) = __pyx_v_R2;
    }

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":154
 ...
 * 
 */
    __pyx_t_8 = ((__pyx_v_R1 != __pyx_v_R2) != 0);
    if (__pyx_t_8) {

      /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":155
 *         # in the spanning tree.
 *         if R1 != R2:
 *             n_edges_in_mst += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":159
 *             # Use approximate (because of path-compression) rank to try
 ...
 */
      ...
      __pyx_t_8 = (((*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_rank.data) + __pyx_t_21)) ))) > (*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_rank.data) + __pyx_t_22)) )))) != 0);
      if (__pyx_t_8) {

        /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":160
 *             # to keep balanced trees.
 *             if rank[R1] > rank[R2]:
 *                 predecessors[R2] = R1             # <<<<<<<<<<<<<<
 *             elif rank[R1] < rank[R2]:
 ...
 */
        ...
        *((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_predecessors.data) + __pyx_t_23)) )) = __pyx_v_R1;
 ...
 */
      ...
      /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":161
 *             if rank[R1] > rank[R2]:
 *                 predecessors[R2] = R1
 *             elif rank[R1] < rank[R2]:             # <<<<<<<<<<<<<<
 *                 predecessors[R1] = R2
 ...
 */
      ...
      __pyx_t_8 = (((*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_rank.data) + __pyx_t_24)) ))) < (*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_rank.data) + __pyx_t_25)) )))) != 0);
      if (__pyx_t_8) {

        /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":162
 *                 predecessors[R2] = R1
 *             elif rank[R1] < rank[R2]:
 *                 predecessors[R1] = R2             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        ...
        *((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_predecessors.data) + __pyx_t_26)) )) = __pyx_v_R2;
 ...
 */
      ...
      /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":164
 *                 predecessors[R1] = R2
 *             else:
 *                 predecessors[R2] = R1             # <<<<<<<<<<<<<<
 *                 rank[R1] += 1
 ...
 */
      /*else*/ {
        ...
        *((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_predecessors.data) + __pyx_t_27)) )) = __pyx_v_R1;

        /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":165
 *             else:
 *                 predecessors[R2] = R1
 *                 rank[R1] += 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        ...
        *((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_rank.data) + __pyx_t_28)) )) += 1;
      }
      __pyx_L20:;
 ...
 */
    ...
    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":167
 *                 rank[R1] += 1
 *         else:
 *             data[j] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    /*else*/ {
      ...
      *((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t *) __pyx_v_data.data) + __pyx_t_29)) )) = 0.0;
    }
    __pyx_L19:;

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":169
 *             data[j] = 0
 * 
 *         i += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":172
 * 
 *     # We may have stopped early if we found a full-sized MST so zero out the rest
 *     while i < n_data:             # <<<<<<<<<<<<<<
 *         j = i_sort[i]
 ...
 */
  while (1) {
    __pyx_t_8 = ((__pyx_v_i < __pyx_v_n_data) != 0);
    if (!__pyx_t_8) break;

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":173
 *     # We may have stopped early if we found a full-sized MST so zero out the rest
 *     while i < n_data:
 *         j = i_sort[i]             # <<<<<<<<<<<<<<
 *         data[j] = 0
 ...
 */
    ...
    __pyx_v_j = (*((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t *) __pyx_v_i_sort.data) + __pyx_t_30)) )));

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":174
 *     while i < n_data:
 *         j = i_sort[i]
 *         data[j] = 0             # <<<<<<<<<<<<<<
 *         i += 1
 ...
 */
    ...
    *((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t *) __pyx_v_data.data) + __pyx_t_31)) )) = 0.0;

    /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":175
 *         j = i_sort[i]
 *         data[j] = 0
 *         i += 1             # <<<<<<<<<<<<<<
 * 
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "scipy.sparse.csgraph._min_spanning_tree.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "scipy.sparse.csgraph._min_spanning_tree.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "scipy.sparse.csgraph._min_spanning_tree.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "scipy.sparse.csgraph._min_spanning_tree._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_minimum_spanning_tree_line_13, __pyx_k_minimum_spanning_tree_line_13, sizeof(__pyx_k_minimum_spanning_tree_line_13), 0, 1, 0, 0},
  ...
  {&__pyx_n_s_scipy_sparse_csgraph__min_spanni, __pyx_k_scipy_sparse_csgraph__min_spanni, sizeof(__pyx_k_scipy_sparse_csgraph__min_spanni), 0, 0, 1, 1},
 ...
 *     minimum_spanning_tree(csgraph, overwrite=False)
 */
  __pyx_tuple__20 = PyTuple_Pack(11, __pyx_n_s_csgraph, __pyx_n_s_overwrite, __pyx_n_s_N, __pyx_n_s_data, __pyx_n_s_indices, __pyx_n_s_indptr, __pyx_n_s_rank, __pyx_n_s_predecessors, __pyx_n_s_i_sort, __pyx_n_s_row_indices, __pyx_n_s_sp_tree); if (unlikely(!__pyx_tuple__20)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(2, 0, 11, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_kyleong_Dropbox_nueral_sc, __pyx_n_s_minimum_spanning_tree, 13, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_min_spanning_tree", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_scipy__sparse__csgraph___min_spanning_tree) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "scipy.sparse.csgraph._min_spanning_tree")) {
      if (unlikely(PyDict_SetItemString(modules, "scipy.sparse.csgraph._min_spanning_tree", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":8
 * cimport cython
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_csr_matrix); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_csr_matrix, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_isspmatrix_csc); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_isspmatrix_csc, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_isspmatrix); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_isspmatrix, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":9
 * 
 * from scipy.sparse import csr_matrix, isspmatrix_csc, isspmatrix
 * from scipy.sparse.csgraph._validation import validate_graph             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_scipy_sparse_csgraph__validation, __pyx_t_2, -1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_ImportFrom(__pyx_t_1, __pyx_n_s_validate_graph); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_validate_graph, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * 
 */
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_float64); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_DTYPE, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 
 */
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_int32); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_ITYPE, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     minimum_spanning_tree(csgraph, overwrite=False)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5scipy_6sparse_7csgraph_18_min_spanning_tree_1minimum_spanning_tree, NULL, __pyx_n_s_scipy_sparse_csgraph__min_spanni); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_minimum_spanning_tree, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "scipy/sparse/csgraph/_min_spanning_tree.pyx":1
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_minimum_spanning_tree_line_13, __pyx_kp_u_minimum_spanning_tree_csgraph_o) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init scipy.sparse.csgraph._min_spanning_tree", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init scipy.sparse.csgraph._min_spanning_tree");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t(PyObject *obj) {
    ...
    retcode = __Pyx_ValidateAndInit_memviewslice(axes_specs, __Pyx_IS_C_CONTIG,
                                                 ...
                                                 &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_DTYPE_t, stack,
                                                 &result, obj);
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t(PyObject *obj) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[1];
    int axes_specs[] = { (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_CONTIG) };
    int retcode;
    ...
    retcode = __Pyx_ValidateAndInit_memviewslice(axes_specs, __Pyx_IS_C_CONTIG,
                                                 (PyBUF_C_CONTIGUOUS | PyBUF_FORMAT | PyBUF_WRITABLE), 1,
                                                 &__Pyx_TypeInfo_nn___pyx_t_5scipy_6sparse_7csgraph_18_min_spanning_tree_ITYPE_t, stack,
                                                 &result, obj);
    if (unlikely(retcode == -1))
        goto __pyx_fail;
    return result;
