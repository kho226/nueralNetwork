...
if(F2PyCapsule_Check(kernel_func_capi)) {
  ...
  omega_Dims[0]=n;
  capi_omega_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_C|F2PY_INTENT_OUT;
...
/*frompyobj*/
  ...
  /* Processing variable omega */
  omega_Dims[0]=n;
  capi_omega_intent |= F2PY_INTENT_C|F2PY_INTENT_IN|F2PY_INTENT_CACHE;
...
/*frompyobj*/
  ...
  omega_real_Dims[0]=n;
  capi_omega_real_intent |= F2PY_INTENT_C|F2PY_INTENT_IN|F2PY_INTENT_CACHE;
  ...
  omega_imag_Dims[0]=n;
  capi_omega_imag_intent |= F2PY_INTENT_C|F2PY_INTENT_IN|F2PY_INTENT_CACHE;
